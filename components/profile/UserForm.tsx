...
import { uploadImageToCloudinary } from "@/services/axiosInstance";
...
const validateFormData = ( formData: any, avatar: any ) => {
      ...
      if ( !avatar.trim() ) {
            Toast.show( { type: "error", text1: "Avatar  is required." } );
            return false;
      }
      return true;
};
